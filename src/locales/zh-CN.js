...
export default {
    ...
    menu: '菜单',
    'menu.home': '首页',
    'menu.organization': '机构',
    'menu.dashboard': '仪表盘',
    'menu.dashboard.analysis': '数据看板',
    'menu.dashboard.aboutme': '与我相关',
    'menu.dashboard.workplace': '工作统计',
    'menu.dashboard.log': '系统日志',
    'menu.project': '项目',
    'menu.investors': '投资人',
    'menu.fund': '基金',
    'menu.files': '文件柜',
    'menu.task': '任务',
    'menu.tools': '工具箱',
    'menu.tools.due-diligence': '一键尽调',
    'menu.tools.background-check': '背景调查',
    'menu.setting': '设置',
    'menu.setting.roles': '角色管理',
    'menu.setting.services': '购买服务',
    'menu.setting.webhook': 'WebHook',
    'menu.task.create': '创建任务',
    'menu.task.view': '任务详情',
    'menu.fund.create': '创建基金',
    'menu.project.create': '创建项目',
    'menu.project.view': '项目详情',
    'menu.fund.view': '基金详情',
    'menu.investor.view': '投资人详情',
    'menu.investor.create': '添加投资人',
    'menu.organization.create': '创建机构',
    'menu.messages': '消息中心',
    'menu.form': '表单页',
