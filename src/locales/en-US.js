export default {
    ...
    'menu.dashboard.aboutme': 'About Me',
    'menu.dashboard.workplace': 'Workplace',
    'menu.dashboard.log': 'System Log',
    ...
    'menu.task': 'Task',
    'menu.tools': 'Tools',
    'menu.tools.due-diligence': 'Due Diligence',
    'menu.tools.background-check': 'Background Check',
    'menu.setting': 'Setting',
    'menu.setting.roles': 'Roles',
    'menu.setting.services': 'Services',
    'menu.setting.webhook': 'WebHook',
    'menu.task.create': 'Create Task',
    'menu.fund.create': 'Create Found',
    'menu.project.create': 'Create Project',
    'menu.investor.create': 'Add Investor',
    'menu.organization.create': 'Create Organization',
